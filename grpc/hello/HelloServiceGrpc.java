...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<hello.Hello.HelloRequest,
      hello.Hello.HelloResponse> getHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<hello.Hello.HelloRequest,
      hello.Hello.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<hello.Hello.HelloRequest, hello.Hello.HelloResponse> getHelloMethod;
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(hello.Hello.HelloRequest request,
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(hello.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<hello.Hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public hello.Hello.HelloResponse hello(hello.Hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<hello.Hello.HelloResponse> hello(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((hello.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<hello.Hello.HelloResponse>) responseObserver);
          break;
        default:
